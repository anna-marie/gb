  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved type as @type" do
        ...
        post :create, {:type => { "content" => "invalid value" }}, valid_session
        assigns(:type).should be_a_new(Type)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested type" do
        ...
        Type.any_instance.should_receive(:update).with({ "content" => "MyString" })
        put :update, {:id => type.to_param, :type => { "content" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the type as @type" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Type.any_instance.stub(:save).and_return(false)
        put :update, {:id => type.to_param, :type => { "content" => "invalid value" }}, valid_session
        assigns(:type).should eq(type)
      end
